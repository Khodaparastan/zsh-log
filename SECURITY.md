...
- **File permissions**: log files are created with the default `umask` of the calling process. If logging sensitive data, set a restrictive `umask` before calling `z::log::setup`.
